  ...
  _createClass(DDBStorageBackend, [{
    ...
    */
    ...
    value: function buildSelectQuery(variables) {
      ...
      if (variables.hasOwnProperty('table')) query.TableName = this.prefixedTableName(variables.table);else if (!query.hasOwnProperty('TableName')) query.TableName = this.getStorageTableName();
      return query;
    }
